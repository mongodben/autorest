# How AutoRest Generates Code From an OpenAPI Definition

## Contents

- [How AutoRest Generates Code From an OpenAPI Definition](#-how-autorest-generates-code-from-an-openapi-definition)
  - [Contents](#contents)
